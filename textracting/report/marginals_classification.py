## @file
# Marginal line classification module: Functions for classifying a line as a marginal (header or footer)
# by Anna Andraszek
...
def create_dataset():
    ...
    prev_dataset = paths.dataset_path + 'marginals_dataset_v2.csv'
...
def get_marginals(data, mode=paths.dataset_version):
